...
$textos_temporal = new Textos($_REQUEST['principal'],$_REQUEST['principal_ing'],$_REQUEST['tickets'],$_REQUEST['tickets_ing'],$_REQUEST['tickets_bus'],$_REQUEST['tickets_bus_ing'],$_REQUEST['schedules'],$_REQUEST['schedules_ing']);
