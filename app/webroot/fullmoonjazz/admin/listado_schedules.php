        ...
        <div id="pane-content">
          <div class="widget minimizable g4">
            <header> <i class="icon-clipboard"></i>
              <h2>Listado schedule Merida</h2>
            </header>
            <div class="widget-section">
              <div class="content"> 
                <!--inicio formilacion --> 
                <a href="form_schedule.php"> <span><i class="icon-new"></i>Nuevo registro</span></a>
                &nbsp; &nbsp;
                  ...
                  <table>
                    ...
                    <tbody>
                      <?php
								...
								{
								echo '<tr>';	
								echo '<td>'.$elemento_schedules_bus['hora'].'</td>';
								echo '<td>'.$elemento_schedules_bus['locacion'].'</td>';
								echo '<td>'.$elemento_schedules_bus['status']. ' Bus</td>';
								echo '<td>'.$elemento_schedules_bus['tipo'].'</td>';
								echo '<td><a href="form_schedule.php?id='.$elemento_schedules_bus['idlocacion'].'" title="Actualizar"><span><i class="icon-pencil-2"></i>&nbsp;</span></a><a href="eliminar.schedule.php?id='.$elemento_schedules_bus['idlocacion'].'" title="Eliminiar"><span><i class="icon-remove-2"></i>&nbsp;</span></a> </td></td>';	
                   ...
                   <table>
                    ...
                    <tbody>
                      <?php
								...
								{
								echo '<tr>';	
								echo '<td>'.$elemento_schedules_coast['hora'].'</td>';
								echo '<td>'.$elemento_schedules_coast['locacion'].'</td>';
								echo '<td>'.$elemento_schedules_coast['status']. ' Bus</td>';
								echo '<td>'.$elemento_schedules_coast['tipo'].'</td>';
								echo '<td><a href="form_schedule.php?id='.$elemento_schedules_coast['idlocacion'].'" title="Actualizar"><span><i class="icon-pencil-2"></i>&nbsp;</span></a><a href="eliminar.schedule.php?id='.$elemento_schedules_coast['idlocacion'].'" title="Eliminiar"><span><i class="icon-remove-2"></i>&nbsp;</span></a> </td></td>';	
