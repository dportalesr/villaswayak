...
<html>
    ...
    <body class="fixed fixed-topbar"><!-- .fixed or .fluid -->
		<div id="wrapper">
			...
			<section id="pane">
						<header>
							<h1>Modulo galeria</h1>
							<nav class="breadcrumbs">
								<ul>
									<li class="alt"><a href="index.php"><i class="icon-home"></i></a></li>
									<li><a href="listado_galeria.php">Listado</a></li>
									<li><a href="form_galeria.php">Formulario</a></li>
						...
						<div id="pane-content">
								...
								<div class="widget-section">
									...
									<div class="content">
                                       <!--inicio formilacion -->
                                      <a href="form_galeria.php"> <span><i class="icon-new"></i>Nuevo registro</span></a>
                                       &nbsp;
                                       &nbsp;
							...
							<table>
								...
								{
								echo '<tr>';	
								echo '<td>'.$elemento_galeria['imagen'].'</td>';
								echo '<td> <a target="_new" title="Ver imagen" href="galeria/galeria/'.$elemento_galeria['imagen'].'"><span><i class="glyph-image"></i>&nbsp;</span></a> <a href="eliminar.galeria.php?id='.$elemento_galeria['idimagen'].'&nombre='.$elemento_galeria['imagen'].'" title="Eliminiar"><span><i class="icon-remove-2"></i>&nbsp;</span></a></td>';	
								echo '</tr>';
								}
								 ?>
