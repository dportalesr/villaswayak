			...
			<section id="pane">
						...
						<div id="pane-content">
								...
								<header>
									...
									<h2>Formulario galeria </h2>
								</header>
								<div class="widget-section">
                              
									<div class="content">
                                       <!--inicio formilacion -->
                                    <form action="operaciones.galeria.php" method="post" enctype="multipart/form-data" class="js-validate" />
                                    <input type="hidden" name="limite" value="500000" >
                         
                                        <div class="field g2">
											<label>Imagen <span>(553px por 390px en jpg)</span></label>
											<div class="entry">
