			...
			<section id="pane">
						...
						<div id="pane-content">
								...
								<header>
									...
									<h2>Formulario folleto </h2>
								</header>
								<div class="widget-section">
                              
									<div class="content">
                                       <!--inicio formilacion -->
                                    <form action="operaciones.folleto.php" method="post" enctype="multipart/form-data" class="js-validate" />
                                    <input type="hidden" name="limite" value="500000" >
                         
                                        <div class="field g2">
											<label>Imagen <span></span></label>
											<div class="entry">
												<input type="file" name="archivo" class="custom-file  {fileDefaultText: 'Attach a file', fileBtnText: 'click to load'}" /><!-- use options only if you will translate, or edit directly .js -->
											</div>
										</div>
                               
                                        <div class="field g3">
                                        <?php echo $botones_add; ?>
                                        </div>
                 				   </form>
							...
							<table>
								...
								{
								echo '<tr>';	
								echo '<td>'.$elemento_folleto['imagen'].'</td>';
								echo '<td> <a target="_new" title="Ver imagen" href="galeria/folleto/'.$elemento_folleto['imagen'].'"><span><i class="glyph-image"></i>&nbsp;</span></a> <a href="eliminar.folleto.php?nombre='.$elemento_folleto['imagen'].'" title="Eliminiar"><span><i class="icon-remove-2"></i>&nbsp;</span></a></td>';	
								echo '</tr>';
								}
								 ?>
								</tbody>
