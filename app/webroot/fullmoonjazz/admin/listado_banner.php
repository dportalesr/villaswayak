			...
			<section id="pane">
						<header>
							...
							<nav class="breadcrumbs">
								<ul>
									...
									<li><a href="listado_banner.php">Listado</a></li>
									<li><a href="form_banner.php">Formulario</a></li>
						...
						<div id="pane-content">
								...
								<div class="widget-section">
									...
									<div class="content">
                                       <!--inicio formilacion -->
                                      <a href="form_banner.php"> <span><i class="icon-new"></i>Nuevo registro</span></a>
                                       &nbsp;
                                       &nbsp;
							...
							<table>
								...
								{
								echo '<tr>';	
								echo '<td>'.$elemento_banner['banner'].'</td>';
								echo '<td> <a target="_new" title="Ver imagen" href="galeria/banner/'.$elemento_banner['banner'].'"><span><i class="glyph-image"></i>&nbsp;</span></a> <a href="eliminar.banner.php?id='.$elemento_banner['idbanner'].'&nombre='.$elemento_banner['banner'].'" title="Eliminiar"><span><i class="icon-remove-2"></i>&nbsp;</span></a></td>';	
								echo '</tr>';
								}
								 ?>
