			...
			<section id="pane">
						...
						<div id="pane-content">
								...
								<header>
									...
									<h2>Formulario patrocinadores (Alto maximo de las imágenes 75px,archivos png)</h2>
								</header>
								<div class="widget-section">
                              
									<div class="content">
                                       <!--inicio formilacion -->
                                    <form action="operaciones.patrociandores.php" method="post" enctype="multipart/form-data" class="js-validate" />
                               ...
                               <div class="field g1">
											<label>Nombre</label>
											<div class="entry">
												<input type="text" name="nombre" value="" placeholder="Placeholder" />
											</div>
										</div>
                                        <div class="field g3">
