...
$correo = new Destinatarios();
$correo->obtener_destinatarios();
	$botones_up='';
	$botones_delete='';
	$operaciones='Guardar';
    ...
    <body class="fixed fixed-topbar"><!-- .fixed or .fluid -->
		<div id="wrapper">
			...
			<section id="pane">
                       ...
                       <form action="operaciones.destinatarios.php" method="post" enctype="multipart/form-data" class="js-validate" />
							<div class="field g1">
											<label>Correo 1</label>
											<div class="entry">
												<input type="text" name="correo1" value="<?php echo $correo->mail1;?>" placeholder="Placeholder" />
											</div>
										</div>
                                        <div class="field g1">
											<label>Correo 2</label>
											<div class="entry">
												<input type="text" name="correo2" value="<?php echo $correo->mail2 ;?>" placeholder="Placeholder" />
											</div>
										</div>
                                       <div class="field g1">
											<label>Correo 3</label>
											<div class="entry">
												<input type="text" name="correo3" value="<?php echo $correo->mail3;?>" placeholder="Placeholder" />
											</div>
										</div> 
