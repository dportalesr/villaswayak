...
$marca = new Marca();
$listado_marca =$marca->listar_marca();
?>
<!DOCTYPE html>
<html>
<head>
...
<div id="wrapper">
  <section id="top">
    <header>
      <nav id="menu-bar">
        <ul>
          <li> <a href="#">Notifications <span class="note">7</span></a> </li>
          <li class="with-submenu"> <a href="#">System settings</a>
            <nav class="submenu">
              <ul>
  ...
  <section id="page">
    <aside id="sidebar">
      <div id="logo"> <a href="./index.php.html"><img src="./images/logo.png" alt="Mighty Admin" /></a> </div>
      <div class="menus"> 
        <!-- menu #1 -->
        	<nav>
							<h2>Main Menu</h2>
    ...
    <section id="content">
      <section id="content-top">
        <div class="search-field-entry">
          ...
          <input type="submit" class="search-button" value="L" />
          <!-- L is the glyph for the search icon --> 
        </div>
        <nav class="quick-actions">
          <ul>
            <li> <a href="#"> <i class="glyph-attachment"></i> </a> </li>
            <li class="with-submenu"> <a href="#"> <i class="glyph-favorite"></i> </a>
              <nav class="submenu">
                <ul>
            ...
            <li> <a href="#"> <i class="glyph-settings"></i> </a> </li>
            <li> <a href="#"> <i class="glyph-search"></i> </a> </li>
        ...
        <div id="pane-content">
          <div class="widget minimizable g4">
            ...
            <div class="widget-section">
              <div class="content"> 
                <!--inicio formilacion --> 
                <a href="form_marcas.php"> <span><i class="icon-new"></i>Nuevo registro</span></a> &nbsp;
                &nbsp;
                <div class="table-wrapper">
                  <table>
                    ...
                    <tbody>
                      <?php
								foreach($listado_marca as $elemento_marca )
								{
								echo '<tr>';	
								echo '<td>'.$elemento_marca['nombre'].'</td>';
								echo '<td><a href="form_marcas.php?id='.$elemento_marca['idmarca'].'" title="Actualizar"><span><i class="icon-pencil-2"></i>&nbsp;</span></a> &nbsp; <a href="eliminar.marca.php?id='.$elemento_marca['idmarca'].'" title="Eliminiar"><span><i class="icon-remove-2"></i>&nbsp;</span></a></td>';	
								echo '</tr>';
								}
								 ?>
                    </tbody>
