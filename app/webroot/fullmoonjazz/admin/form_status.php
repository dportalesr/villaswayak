...
$status= new Status('');
$status->obtener_status();
$status_check= new Status('');
    ...
    <body class="fixed fixed-topbar"><!-- .fixed or .fluid -->
		<div id="wrapper">
			...
			<section id="pane">
                       ...
                       <form action="operaciones.status.php" method="post" enctype="multipart/form-data" class="js-validate" />
							<div class="field g3">
											<label>Habilitar idioma español</label>
                                           
											<div class="entry list">
												<label><input type="radio" name="r1" <?php if($status_check->valor==1){echo 'checked=""';} ?> value="1" /> Si</label>
												<label><input type="radio" name="r1" <?php if($status_check->valor==0){echo 'checked=""';} ?> value="0" /> No</label>
											</div>
										</div>
