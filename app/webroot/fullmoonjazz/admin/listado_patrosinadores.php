...
<html>
    ...
    <body class="fixed fixed-topbar"><!-- .fixed or .fluid -->
		<div id="wrapper">
			...
			<section id="pane">
						<header>
							<h1>Modulo patrocinadores</h1>
							<nav class="breadcrumbs">
								<ul>
									<li class="alt"><a href="index.php"><i class="icon-home"></i></a></li>
									<li><a href="listado_patrosinadores.php">Listado</a></li>
									<li><a href="form_patrocinadores.php">Formulario</a></li>
								</ul>
							</nav>
						</header>
						<div id="pane-content">
							<div class="widget minimizable g4">
								...
								<div class="widget-section">
									...
									<div class="content">
                                       <!--inicio formilacion -->
                                      <a href="form_patrocinadores.php"> <span><i class="icon-new"></i>Nuevo registro</span></a>
                                       &nbsp;
                                       &nbsp;
							...
							<table>
								...
								{
								echo '<tr>';	
								echo '<td>'.$elemento_patrocinador['logo'].'</td>';
								echo '<td>'.$elemento_patrocinador['nombre'].'</td>';
								echo '<td> <a target="_new" title="Ver imagen" href="galeria/logo/'.$elemento_patrocinador['logo'].'"><span><i class="glyph-image"></i>&nbsp;</span></a> <a href="eliminar.patrocinador.php?id='.$elemento_patrocinador['idPatrosinador'].'&nombre='.$elemento_patrocinador['logo'].'" title="Eliminiar"><span><i class="icon-remove-2"></i>&nbsp;</span></a></td>';	
								echo '</tr>';
								}
								 ?>
